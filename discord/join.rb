module Join
  ...
  command(:join, min_args: 0, max_args: 2, description: "Joins channel on IRC, and creates channel on Discord if channel doesn't already exist.") do |event, channel = nil, pass = nil|
    if channel.nil?
